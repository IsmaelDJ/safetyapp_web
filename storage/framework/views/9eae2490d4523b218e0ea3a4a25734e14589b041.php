                        ...
                        <?php $__currentLoopData = $carriers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $carrier): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                <td class="text-center">
                                    <img class="rounded-circle" src="<?php echo e(asset($carrier->user->avatar)); ?>" alt="avatar" height="35" width="35">
                                </td>
                                <td >
                                ...
                                <td  style="width: 200px">
                                    <div class="d-flex gap-3">
                                        <a href="<?php echo e(route('carriers.show', $carrier)); ?>"
                                           class="btn btn-default">Détails
                                        </a>
                                        <a href="<?php echo e(route('carriers.edit', $carrier)); ?>"
                                           class="btn btn-info">Modifier
                                        </a>

                                        <a href="<?php echo e(route('carriers.index')); ?>" class="btn btn-danger"
                                           onclick="
                                        ...
                                        <form method="POST" id="delete-form<?php echo e($carrier->id); ?>"
                                              action="<?php echo e(route('carriers.destroy', [$carrier])); ?>">
                                            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/chad/laravel-workspace/safetyapp_web/resources/views/carriers/index.blade.php ENDPATH**/ ?>