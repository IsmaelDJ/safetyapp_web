                        ...
                        <div class="text-sm-end">
                            <div class="btn-group">
                                ...
                                <div class="dropdown-menu">
                                    <a class="dropdown-item" href="<?php echo e(route('analyze.export.xlsx.quiz.correct')); ?>" >Format Excel</a>
                                    <a class="dropdown-item" href="<?php echo e(route('analyze.export.pdf.quiz.correct')); ?>">Format PDF</a>
                                </div>
                            </div>
                        </div>
                    </div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/chad/laravel-workspace/safetyapp_web/resources/views/analyze/quiz-correct.blade.php ENDPATH**/ ?>