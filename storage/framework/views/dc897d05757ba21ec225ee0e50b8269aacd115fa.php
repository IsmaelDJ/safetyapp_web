<?php if($paginator->hasPages()): ?>
    <nav class="d-flex justify-items-center justify-content-between">
        ...
        <div class="d-none flex-sm-fill d-sm-flex align-items-sm-center justify-content-sm-between">
            ...
            <div>
                <ul class="pagination pagination pagination-rounded justify-content-end mb-2">
...
<?php endif; ?>
<?php /**PATH C:\Users\Ismae\Downloads\safetyapp_web-master\safetyapp_web-master\resources\views/vendor/pagination/round.blade.php ENDPATH**/ ?>