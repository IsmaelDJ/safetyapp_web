...
} elseif ($_instance->childHasBeenRendered('zqMyYUG')) {
    $componentId = $_instance->getRenderedChildComponentId('zqMyYUG');
    $componentTag = $_instance->getRenderedChildComponentTagName('zqMyYUG');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('zqMyYUG');
} else {
    $response = \Livewire\Livewire::mount('chart-reading');
    $html = $response->html();
    $_instance->logRenderedChild('zqMyYUG', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
</div>  
