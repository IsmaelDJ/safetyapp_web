                        ...
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('view', $driver)): ?>
                            <tr>
                                <td class="text-center">
                                    <img class="rounded-circle" style="object-fit: cover" src="<?php echo e(asset($driver->avatar)); ?>" alt="avatar" height="35" width="35">
                                </td>
                                <td>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\www\ismatech\safetyapp_web\resources\views/drivers/index.blade.php ENDPATH**/ ?>