...
<?php $__env->startSection('content'); ?>
    ...
    <div class="card">
        ...
        <div class="row g-0">
            <form action="<?php echo e(route('quiz_responses.update',$quizResponse)); ?>" method="post" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                            ...
                            <div class="w-100">
                                ...
                                <div class="mb-3">
                                    ...
                                    <img id="ruleImage" class="img-fluid mb-1"
                                         src="<?php echo e(URL::asset($quizResponse->image)); ?>">
...
unset($__errorArgs, $__bag); ?>"><?php echo e($quizResponse->description); ?></textarea>
                                ...
                                <div class="mt-5">
                                    <div class="mb-3">
                                        ...
                                        <div class="essential_audio"
                                             data-url="<?php echo e(URL::asset($quizResponse->fr)); ?>"></div>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="essential_audio"
                                             data-url="<?php echo e(URL::asset($quizResponse->ar)); ?>"></div>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="essential_audio"
                                             data-url="<?php echo e(URL::asset($quizResponse->ng)); ?>"></div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\safetyapp\resources\views/quiz_responses/edit.blade.php ENDPATH**/ ?>