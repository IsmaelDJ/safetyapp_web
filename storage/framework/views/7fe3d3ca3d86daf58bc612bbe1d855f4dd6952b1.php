...
} elseif ($_instance->childHasBeenRendered('Uis9GQC')) {
    $componentId = $_instance->getRenderedChildComponentId('Uis9GQC');
    $componentTag = $_instance->getRenderedChildComponentTagName('Uis9GQC');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('Uis9GQC');
} else {
    $response = \Livewire\Livewire::mount('register-form');
    $html = $response->html();
    $_instance->logRenderedChild('Uis9GQC', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                                </div>
...
<?php echo $__env->make('layouts.master-without-nav', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\safetyapp_web\resources\views/auth/register.blade.php ENDPATH**/ ?>