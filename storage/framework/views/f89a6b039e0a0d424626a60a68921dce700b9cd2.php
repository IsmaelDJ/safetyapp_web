        ...
        <div class="card">
            <div class="card-body">
                <div class="d-flex align-items-start">
                    <div class="me-2">
                        <h5 class="card-title mb-4">Liste des quiz ayant des mauvaises reponses</h5>
                    </div>
                        ...
                        <div class="text-sm-end">
                            <div class="btn-group">
                                ...
                                <div class="dropdown-menu">
                                    <a class="dropdown-item" href="<?php echo e(route('analyze.export.xlsx.quiz.false')); ?>" >Format Excel</a>
                                    <a class="dropdown-item" href="<?php echo e(route('analyze.export.pdf.quiz.false')); ?>">Format PDF</a>
                                </div>
                            </div>
                        </div>
                    </div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/chad/laravel-workspace/safetyapp_web/resources/views/analyze/quiz-false.blade.php ENDPATH**/ ?>