                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text text-center fs-3">
                                ...
                                <i class="mdi mdi-check me-1 text-success"></i>
                                <?php else: ?>
                                <i class="mdi mdi-close me-1 text-danger"></i>
                                <?php endif; ?>
                            </td>
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('doAdvanced')): ?>
                            <td style="width: 300px">
                                <div class="d-flex gap-3">
                                    <a href="<?php echo e(route('driver_quiz_responses.show',[$driverQuizResponse->id])); ?>" class="btn btn-primary">Détails
                                    </a>
                                    <div class="d-flex gap-3">
                                        <a href="<?php echo e(route('driver_quiz_responses.drivers',[$driverQuizResponse->driver_id])); ?>" class="btn btn-outline-secondary">Autres reponses
                                        </a>
                                    </div>
                                </div>
                            </td>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\www\ismatech\safetyapp_web\resources\views/driver_quiz_responses/index.blade.php ENDPATH**/ ?>