...
} elseif ($_instance->childHasBeenRendered('m5DPvxF')) {
    $componentId = $_instance->getRenderedChildComponentId('m5DPvxF');
    $componentTag = $_instance->getRenderedChildComponentTagName('m5DPvxF');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('m5DPvxF');
} else {
    $response = \Livewire\Livewire::mount('register-form');
    $html = $response->html();
    $_instance->logRenderedChild('m5DPvxF', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                                </div>
