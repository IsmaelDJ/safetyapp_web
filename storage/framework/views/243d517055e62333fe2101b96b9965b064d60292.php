            ...
            <div class="col-xl-4">
                <div class="auth-full-page-content p-md-5 p-4">
                    <div class="w-100">
                        ...
                        <form action="<?php echo e(route('driver_quiz_responses.store')); ?>" method="post" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
                            <label class="col-md-5 col-form-label">Chauffeur</label>
                            <div class="mb-4">
                                <select
                                    class="form-select form-select-lg <?php $__errorArgs = ['driver_id'];
...
$message = $__bag->first($__errorArgs[0]); ?>
                                <span class="invalid-feedback" role="alert">
                                    <strong>Chauffeur non selectionnée</strong>
                                </span>
                                <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/chad/laravel-workspace/safetyapp_web/resources/views/driver_quiz_responses/create.blade.php ENDPATH**/ ?>