            ...
            <div class="col-xl-4">
                <div class="auth-full-page-content p-md-5 p-4">
                    <div class="w-100">
                        ...
                        <form action="<?php echo e(route('drivers.update', $driver)); ?>" method="post" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
                            <div class="mb-3">
                                <div>
                                    <label for="avatar" class="form-label">Photo de profile</label>
                                </div>
                                <img id="driverAvatar" class="img-fluid mb-1" src="<?php echo e(URL::asset($driver->avatar)); ?>">
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control form-control-lg <?php $__errorArgs = ['obc'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="mb-2">
                                <select
                                    class="form-select form-select-lg <?php $__errorArgs = ['user_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                    name="user_id">
                                    <option selected value="<?php echo e($driver->user->id); ?>"><?php echo e($driver->user->name); ?></option>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/chad/laravel-workspace/safetyapp_web/resources/views/drivers/edit.blade.php ENDPATH**/ ?>