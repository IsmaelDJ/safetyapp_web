                        ...
                        <div class="btn-group   !spacing" role="group">
                            <div class="btn-group">
                                ...
                                <div class="dropdown-menu">
                                    <a class="dropdown-item" href="<?php echo e(route('particulars.export.xlsx')); ?>">Excel</a>
                                    <a class="dropdown-item" href="<?php echo e(route('particulars.export.pdf')); ?>" target="_blank" download>PDF</a>
                                </div>
                            </div>
                            <a type="button" href="<?php echo e(route('particulars.create')); ?>" class="btn btn-success btn-rounded waves-effect waves-light mb-2 me-2"><i class="mdi mdi-plus me-1"></i> Ajouter
                            </a>
                        </div>
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td class="text-center">
                                <?php if($particular->avatar): ?>
                                <img class="rounded-circle" style="object-fit: cover" src="<?php echo e(asset($particular->avatar)); ?>" alt="avatar" height="35" width="35">
                                <?php else: ?>
                                <img class="rounded-circle" style="object-fit: cover" src="<?php echo e(asset('images/default-avatar.jpg')); ?>" alt="avatar" height="35" width="35">
                                <?php endif; ?>
                            </td>
                            <td>
                            ...
                            <td style="width: 200px">
                                <div class="d-flex gap-3">
                                    ...
                                    <a href="<?php echo e(route('particulars.show', $particular)); ?>" class="btn btn-default">Détails
                                    </a>
                                    <a href="<?php echo e(route('particulars.edit', $particular)); ?>" class="btn btn-info">Modifier
                                    </a>

                                    <a href="<?php echo e(route('particulars.index')); ?>" class="btn btn-danger" onclick="
                                    ...
                                    <form method="POST" id="delete-form<?php echo e($particular->id); ?>" action="<?php echo e(route('particulars.destroy', [$particular])); ?>">
                                        <?php echo csrf_field(); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\www\ismatech\safetyapp_web\resources\views/particulars/index.blade.php ENDPATH**/ ?>