        ...
        <div class="row">
            <div class="col-xl-3">
                <div class="card" style="height: 80vh">
                    <div class="card-body">
                        <div class="card-body">
                            <img src="<?php echo e(URL::asset($carrier->user->avatar)); ?>" alt="" class="img-fluid rounded mb-4" width="300" height="100">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\safetyapp_web\resources\views/carriers/show.blade.php ENDPATH**/ ?>