                ...
                <div class="card" style="height: 80vh">
                    <div class="card-body">
                        <div class="card-body" style="height: 100vh;">
                            <img src="<?php echo e(URL::asset($carrier->avatar)); ?>" alt="" class="img-fluid rounded mb-4" width="300" height="300">
                            <h5 class="card-title"><?php echo e($carrier->name); ?></h5>
                        </div>
                        <i class="mdi mdi-map-marker me-1 "></i><span class="text-muted">E-mail</span>
                        <h4 class="lead mb-4"><?php echo e($carrier->email); ?></h4>
                        <?php if(isset($carrier->carrier)): ?>
                        <i class="mdi mdi-phone me-1 "></i><span class="text-muted">Tel</span>
                        <h4 class="lead mb-4"><?php echo e($carrier->carrier->phone); ?></h4>
                        <i class="mdi mdi-map-marker me-1 "></i><span class="text-muted">Adresse</span>
                        <h4 class="lead mb-4"><?php echo e($carrier->carrier->address); ?></h4>
                        <?php endif; ?>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Ismae\Downloads\safetyapp_web\resources\views/carriers/show.blade.php ENDPATH**/ ?>