...
@section('content')
    ...
    <div class="card">
        ...
        <div class="row g-0">
            <form action="{{route('quiz_responses.update',$quizResponse)}}" method="post" enctype="multipart/form-data">
                @csrf
                            ...
                            <div class="w-100">
                                ...
                                <div class="mb-3">
                                    ...
                                    <img id="ruleImage" class="img-fluid mb-1"
                                         src="{{URL::asset($quizResponse->image)}}">
                            ...
                            <div class="w-100">
                                ...
                                <div class="mb-3 mt-3">
                                    ...
                                    <textarea id="" description placeholder="Entrez la question"
                                              name="description"
                                              class="form-control form-control-lg @error('description') is-invalid @enderror">{{$quizResponse->description}}</textarea>
                                    @error('description')
                                    <span class="invalid-feedback" role="alert">
                                ...
                                <div class="mt-5">
                                    <div class="mb-3">
                                        ...
                                        <div class="essential_audio"
                                             data-url="{{URL::asset($quizResponse->fr)}}"></div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="essential_audio"
                                             data-url="{{URL::asset($quizResponse->ar)}}"></div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="essential_audio"
                                             data-url="{{URL::asset($quizResponse->ng)}}"></div>
