                        ...
                        <tr>
                            ...
                            <td style="width: 300px">
                                <div class="d-flex gap-3">
                                    <a href="{{route('driver_quiz_responses.show',[$driverQuizResponse->id])}}" class="btn btn-primary">Détails
                                    </a>
                                    <div class="d-flex gap-3">
                                        <a href="{{route('driver_quiz_responses.drivers',[$driverQuizResponse->driver_id])}}" class="btn btn-outline-secondary">Autres reponses
                                        </a>
                                    </div>
                                </div>
                            </td>
