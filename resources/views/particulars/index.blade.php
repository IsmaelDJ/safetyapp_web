                        ...
                        <tr>
                            ...
                            <td style="width: 200px">
                                <div class="d-flex gap-3">
                                    ...
                                    <a href="{{route('particulars.show', $particular)}}" class="btn btn-default">Détails
                                    </a>
                                    <a href="{{route('particulars.edit', $particular)}}" class="btn btn-info">Modifier
                                    </a>

                                    <a href="{{route('particulars.index')}}" class="btn btn-danger" onclick="
                                    ...
                                    <form method="POST" id="delete-form{{$particular->id}}" action="{{route('particulars.destroy', [$particular])}}">
                                        @csrf
