                ...
                <div class="row">
                            ...
                            <div class="card card-body">
                                <div class="row">
                                    <div class="col-xl-3">
                                        ...
                                        <h5 class="card-title">{{$employeeQuizResponse->quiz_question->description}}</h5>
                                    </div>
                                    <div class="col-xl-6 m-auto">
                                        <div class="pb-4">
                                            <h5 class=" mt-4">Audio Français</h5>
                                            <div class="essential_audio" data-url="{{URL::asset($employeeQuizResponse->quiz_question->fr)}}"></div>
                                        </div>
                                        <div class="mt-4 pb-4">
                                            <h5 class=" mt-4">Audio Arabe</h5>
                                            <div class="essential_audio" data-url="{{URL::asset($employeeQuizResponse->quiz_question->ar)}}"></div>
                                        </div>
                                        <div class="mt-4 pb-4">
                                            <h5 class=" mt-4">Audio Ngambaye</h5>
                                            <div class="essential_audio" data-url="{{URL::asset($employeeQuizResponse->quiz_question->ng)}}"></div>
                                        </div>
                                    </div>
                                    <div class="col-xl-3">
                                        <div>
                    ...
                    <div class="col-xl-3">
                        <div class="card card-body">
                            ...
                            <h4 class="lead mb-4">{{$employeeQuizResponse->employee->name}}</h4>
                            <i class="mdi mdi-phone me-1 "></i><span class="text-muted">Tel</span>
                            <h4 class="lead mb-4">{{$employeeQuizResponse->employee->phone}}</h4>
                            <i class="mdi mdi-map-marker me-1 "></i><span class="text-muted">Identifiant</span>
                            <h4 class="lead mb-4">{{$employeeQuizResponse->employee->uid}}</h4>
                            <i class="mdi mdi-map-marker me-1 "></i><span class="text-muted">Mot de passe</span>
                            <h4 class="lead mb-4">{{$employeeQuizResponse->employee->password}}</h4>
                        </div>
                    </div>
            </div>
            <div class="row">
                                    ...
                                    <tr>
                                        ...
                                        <td style="width: 200px">
                                            <div class="d-flex gap-3">
                                                ...
                                                <a href="{{route('employee_quiz_responses.show', $employeeQuizResponse->employee_id)}}" class="btn btn-danger"
                                                    onclick="
