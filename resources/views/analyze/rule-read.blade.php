                        ...
                        <div class="text-sm-end">
                            <div class="btn-group">
                                ...
                                <div class="dropdown-menu">
                                    <a class="dropdown-item" href="{{route('analyze.export.xlsx.rule.read')}}" >Format Excel</a>
                                    <a class="dropdown-item" href="{{route('analyze.export.pdf.rule.read')}}">Format PDF</a>
                                </div>
                            </div>
                        </div>
                    </div>
