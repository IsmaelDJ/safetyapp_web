                        ...
                        <div class="text-sm-end">
                            <div class="btn-group">
                                ...
                                <div class="dropdown-menu">
                                    <a class="dropdown-item" href="{{route('analyze.export.xlsx.quiz.waitting')}}" >Format Excel</a>
                                    <a class="dropdown-item" href="{{route('analyze.export.pdf.quiz.waitting')}}">Format PDF</a>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        @foreach($quizzes as $quiz)
                            <tr>
                                <td style="width: 150px;">
                                    <img src="{{URL::asset($quiz->image)}}" alt=""
