                ...
                <div class="ms-auto">
                    <div class="text-sm-end">
                        <div class="btn-group">
                            ...
                            <a type="button" href="{{route('register')}}" class="btn btn-success btn-rounded waves-effect waves-light mb-2 me-2"><i class="mdi mdi-plus me-1"></i> Ajouter
                            </a>
                        </div>
                    </div>
                </div>
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td class="text-center">
                                ...
                                <img src="{{ asset($carrier->user->avatar) }}" alt="Avatar">
                                @else
                            ...
                            <td style="width: 200px">
                                <div class="d-flex gap-3">
                                    <a href="{{route('carriers.show', $carrier)}}" class="btn btn-default">Détails
                                    </a>
                                    <a href="{{route('carriers.edit', $carrier)}}" class="btn btn-info">Modifier
                                    </a>

                                    <a href="{{route('carriers.index')}}" class="btn btn-danger" onclick="
                                    ...
                                    <form method="POST" id="delete-form{{$carrier->id}}" action="{{route('carriers.destroy', [$carrier])}}">
                                        @csrf
